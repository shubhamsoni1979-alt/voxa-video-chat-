    ...
    <section className="py-12 sm:py-16 md:py-24 bg-white relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-16 space-y-2 sm:space-y-3">
          ...
          <h2 className="text-2xl sm:text-4xl md:text-5xl font-black font-serifHeading text-slate-900">
        ...
        {/* Features Grid: 1 col on mobile, 2 cols on tablet, 3 cols on desktop */}
          ...
          {trustFeatures.map((feat, index) => {
            ...
            return (
              <motion.div
                ...
                className="spidey2-card-white rounded-2xl sm:rounded-3xl p-5 sm:p-6 border border-slate-200"
              >
